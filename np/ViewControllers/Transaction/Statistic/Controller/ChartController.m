...
- (NSArray *)getChartData {
    ...
    [items addObject:[[ChartItemData alloc] initWithColor:@"#eeaaff" name:@"식비" percent:@"50" value:@"6000000" type:TRANS_TYPE_EXPENSE]];
    [items addObject:[[ChartItemData alloc] initWithColor:@"#eebbff" name:@"담배" percent:@"16.4" value:@"2000000" type:TRANS_TYPE_EXPENSE]];
